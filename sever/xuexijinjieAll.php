<?php
	...
	$keyHtml=["股票","创业板","科创板","融资融券","港股通","三板","债券","基金","期货","黄金","外汇","其他"];
	for($j =0  ;$j <count($keyHtml) ;$j++){
		
		echo 	$keyHtml[$j];						
	$sql="SELECT * FROM news WHERE type='知识' AND title Like '%".$keyHtml[$j]."%'  order by id desc ";
    $result=$conn->sql($sql);	
	 ...
	 for($i =0  ;$i < $num_results ;$i++)//循环输出每组元素
	  {
		...
		$forHtml.=" <li class='list-group-item list-group-item-success'><a href='zhishi/zhishicontent-".$row['id'].".html'>".$row['title']."</a></li>";
...
<head>
    ...
    <title>学习进阶</title>
    <meta name='keywords' content='股票基础知识，投资知识'>
    <meta name='description' content='股票基础知识，投资知识'>
        ...
        <div class='container'>
            ...
            <div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>
                                <ul class='nav navbar-nav navbar-right'>
                                        ...
                                        <li class='active'><a href='xuexijinjie.html'>学习进阶<span class='sr-only'>(current)</span></a><p class='line-top hidden-xs'></p></li>
	...
	<div class='row'>
		<div class='col-sm-12'>
			<ol class='breadcrumb' style='margin-top: 10px; margin-bottom: 10px;'>
				<li><a href='index.html'>首页</a></li>
				<li><a href='xuexijinjie.html'>学习进阶</a></li><li><a href='index.html'></a></li>				<li class='active'></li>
			</ol>
		</div>
	</div>
</div>
...
<nav class='navbar navbar-default'>
  <div class='container-fluid'>
    ...
    <div class='collapse navbar-collapse' id='bs-example-navbar-collapse-2'>
      <ul class='nav nav-pills nav-stacked' style='margin-top: 3.5rem;'>

        <li class='dropdown'>
          <a href='#' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'>股票 <span class='caret'></span></a>
          <ul class='dropdown-menu'>			  
            <li><a href='xuexijinjie.html'>股票</a></li>
            <li><a href='xuexijinjie-1.html'>创业板</a></li>
            <li><a href='xuexijinjie-2.html'>科创板</a></li>            
            <li><a href='xuexijinjie-3.html'>融资融券</a></li>
			<li><a href='xuexijinjie-4.html'>港股通</a></li>
			<li><a href='xuexijinjie-5.html'>三板</a></li>
          </ul>
        </li>
		<li><a href='xuexijinjie-6.html'>债券</a></li>
		<li><a href='xuexijinjie-7.html'>基金</a></li>
		<li><a href='xuexijinjie-8.html'>期货</a></li>
		<li><a href='xuexijinjie-9.html'>黄金</a></li>
		<li><a href='xuexijinjie-10.html'>外汇</a></li>
		<li><a href='xuexijinjie-11.html'>其他</a></li>
      </ul>
...
<div class='col-xs-12 col-sm-9 usinfo-article'>
	<div class='article-title'>
		<h1 class='h2 titleKey'>".$keyHtml[$j]."<small class='hidden-xs'></small></h1>
	</div>
	<ul class='list-group' v-for='site in sites'>
	 ".$forHtml."
...
if($j==0){
file_put_contents("xuexijinjie.html", $htmlContent);	
}else{
	
 file_put_contents("xuexijinjie-".$j.".html", $htmlContent);
}
};
